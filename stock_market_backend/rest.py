...
DEBUG = config("DEBUG_", cast=bool, default=False)
DISABLED_AUTHENTICATION = config("DISABLED_AUTHENTICATION", cast=bool, default=False)

REST_FRAMEWORK_CONFIGS = {
    "DEFAULT_PAGINATION_CLASS": "stock_market_backend.pagination.CustomPagePagination",
    "PAGE_SIZE": 10,
    ...
    "DEFAULT_THROTTLE_CLASSES": [
        ...
        "base.libs.throttling.CustomScopedRateThrottle",
    ],
